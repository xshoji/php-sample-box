<?php
namespace SymfonyConsoleTemplate\Command;
...
class SampleCommand extends CommandAbstract
{
    ...
    {
        $this->setName('symfony-console-template:sample'); //名前
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /* @var $api_client \SymfonyConsoleTemplate\Service\ApiClient\ApiClientWikipedia */
